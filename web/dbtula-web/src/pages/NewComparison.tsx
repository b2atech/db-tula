...
export default function NewComparison() {
  ...
  return (
    <div className="max-w-xl mx-auto">
      ...
      <div className="bg-white dark:bg-bg-card rounded-xl border border-gray-200 p-6 space-y-5">
        <div>
        ...
        <button
          onClick={handleStart}
          disabled={loading}
          className="w-full bg-brand-orange text-white py-2 rounded-lg font-medium hover:bg-brand-orange-dark disabled:opacity-50"
        >
